...
(function () {
    ...
    this._Sellect = function (selector, options) {
        ...
        {
            var originList = document.querySelector(selector).getAttribute('data-originList').split(",");
            var destinationList = document.querySelector(selector).getAttribute('data-destinationList').split(",");
            this.options = extendDefaults(defaults, {originList,destinationList});
        }
    };
