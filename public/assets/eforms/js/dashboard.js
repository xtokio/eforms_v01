...
var Layout = (function() {
	...
	if($(window).width() > 1200) {
		...
		$(window).resize(function() {
			if( $('body').hasClass('g-sidenav-show') && !$('body').hasClass('g-sidenav-pinned')) {
				$('body').removeClass('g-sidenav-show').removeClass('g-sidenav-pinned').addClass('g-sidenav-hidden');
			}
		})
	}
	...
	$('.sidenav').on('mouseenter', function() {
		if(! $('body').hasClass('g-sidenav-pinned')) {
			$('body').addClass('g-sidenav-show').removeClass('g-sidenav-hide').removeClass('g-sidenav-hidden');
		}
	})

	$('.sidenav').on('mouseleave', function() {
		if(! $('body').hasClass('g-sidenav-pinned')) {
			$('body').removeClass('g-sidenav-show').removeClass('g-sidenav-hidden').addClass('g-sidenav-hide');
			
			$("#lnk_user").attr("aria-expanded", "false");
			$("#navbar-user").removeClass("show");

			setTimeout(function() {
				$('body').removeClass('g-sidenav-show').removeClass('g-sidenav-hide').addClass('g-sidenav-hidden');
			}, 300);
		}
	})
